...
public abstract class AbstractC0519d extends AbstractC0516a implements List, RandomAccess {

    /* renamed from: K  reason: collision with root package name */
    public static final C0517b f5287K = new C0517b(C0522g.f5292N, 0);
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof List) {
            ...
            if (size == list.size()) {
                ...
                C0517b listIterator = listIterator(0);
    ...
    @Override // java.util.List
    /* renamed from: k */
    public AbstractC0519d subList(int r22, int r3) {
        V4.c(r22, r3, size());
        int r32 = r3 - r22;
        if (r32 == size()) {
            return this;
        ...
        if (r32 == 0) {
            return C0522g.f5292N;
        }
        return new C0518c(this, r22, r32);
    }

    @Override // java.util.List
    /* renamed from: l */
    public final C0517b listIterator(int r22) {
        V4.b(r22, size());
        if (isEmpty()) {
            return f5287K;
        }
        return new C0517b(this, r22);
    }
