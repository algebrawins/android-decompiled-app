...
public final class C0417p extends ImageButton {

    /* renamed from: J  reason: collision with root package name */
    public final C0415n f4673J;

    /* renamed from: K  reason: collision with root package name */
    public final C0001b f4674K;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0417p(Context context) {
        super(context, null, R.attr.toolbarNavigationButtonStyle);
        j0.a(context);
        C0415n c0415n = new C0415n(this);
        this.f4673J = c0415n;
        c0415n.b(null, R.attr.toolbarNavigationButtonStyle);
        C0001b c0001b = new C0001b(this);
        this.f4674K = c0001b;
        c0001b.N(R.attr.toolbarNavigationButtonStyle);
    }

    @Override // android.widget.ImageView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        C0415n c0415n = this.f4673J;
        if (c0415n != null) {
            c0415n.a();
        }
        C0001b c0001b = this.f4674K;
        if (c0001b != null) {
            c0001b.f();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        if (!(((ImageView) this.f4674K.f85L).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering()) {
            return true;
        }
        return false;
    }
