...
public class AccessibilityViewEmbedder {
    ...
    private final r reflectionAccessors = new r();
    private final SparseArray<s> flutterIdToOrigin = new SparseArray<>();
    private final Map<s, Integer> originToFlutterId = new HashMap();
    private final Map<View, Rect> embeddedViewToDisplayBounds = new HashMap();

    public AccessibilityViewEmbedder(View view, int r3) {
        this.rootAccessibilityView = view;
        this.nextFlutterId = r3;
    }
    ...
    */
    private void addChildrenToFlutterNode(android.view.accessibility.AccessibilityNodeInfo r10, android.view.View r11, android.view.accessibility.AccessibilityNodeInfo r12) {
        ...
        L3:
            ...
            if (r2 >= r3) goto L9a
            io.flutter.view.r r3 = r9.reflectionAccessors
            java.lang.reflect.Method r4 = r3.f3768f
            r5 = 0
            java.lang.reflect.Field r6 = r3.f3767e
            java.lang.reflect.Method r3 = r3.f3766d
            if (r3 != 0) goto L19
            if (r6 == 0) goto L64
            if (r4 != 0) goto L19
            goto L64
        ...
        L67:
            ...
            long r3 = r3 >> r5
            int r4 = (int) r3
            io.flutter.view.s r3 = new io.flutter.view.s
            r3.<init>(r11, r4)
            java.util.Map<io.flutter.view.s, java.lang.Integer> r5 = r9.originToFlutterId
            boolean r5 = r5.containsKey(r3)
            if (r5 == 0) goto L89
            java.util.Map<io.flutter.view.s, java.lang.Integer> r4 = r9.originToFlutterId
    ...
    private void cacheVirtualIdMappings(View view, int r3, int r4) {
        s sVar = new s(view, r3);
        this.originToFlutterId.put(sVar, Integer.valueOf(r4));
        this.flutterIdToOrigin.put(r4, sVar);
    }
    ...
    */
    private void setFlutterNodeParent(android.view.accessibility.AccessibilityNodeInfo r6, android.view.View r7, android.view.accessibility.AccessibilityNodeInfo r8) {
        /*
            r5 = this;
            io.flutter.view.r r0 = r5.reflectionAccessors
            java.lang.reflect.Method r0 = r0.f3764b
            r1 = 0
        ...
        L2e:
            ...
            r0.setDataPosition(r2)
            long r3 = r0.readLong()
            boolean r6 = io.flutter.view.r.b(r3, r2)
            if (r6 == 0) goto L4d
            r0.readInt()
        L4d:
            r6 = 1
            boolean r6 = io.flutter.view.r.b(r3, r6)
            if (r6 == 0) goto L57
            r0.readLong()
        L57:
            r6 = 2
        ...
        L77:
            ...
            long r0 = r0 >> r6
            int r6 = (int) r0
            java.util.Map<io.flutter.view.s, java.lang.Integer> r0 = r5.originToFlutterId
            io.flutter.view.s r1 = new io.flutter.view.s
            r1.<init>(r7, r6)
    ...
    public AccessibilityNodeInfo createAccessibilityNodeInfo(int r5) {
        ...
        s sVar = this.flutterIdToOrigin.get(r5);
        if (sVar == null) {
            return null;
        }
        Map<View, Rect> map = this.embeddedViewToDisplayBounds;
        View view = sVar.f3769a;
        if (!map.containsKey(view) || view.getAccessibilityNodeProvider() == null || (createAccessibilityNodeInfo = view.getAccessibilityNodeProvider().createAccessibilityNodeInfo(sVar.f3770b)) == null) {
            return null;
        }
    ...
    public Integer getRecordFlutterId(View view, AccessibilityRecord accessibilityRecord) {
        Long a4 = r.a(this.reflectionAccessors, accessibilityRecord);
        if (a4 == null) {
            return null;
        }
        return this.originToFlutterId.get(new s(view, (int) (a4.longValue() >> 32)));
    }
    ...
    */
    public android.view.accessibility.AccessibilityNodeInfo getRootNode(android.view.View r6, int r7, android.graphics.Rect r8) {
        /*
            ...
            io.flutter.view.r r1 = r5.reflectionAccessors
            java.lang.String r2 = "AccessibilityBridge"
            java.lang.reflect.Method r1 = r1.f3763a
            r3 = 0
            if (r1 != 0) goto Lf
        Ld:
            r1 = r3
    ...
    public boolean onAccessibilityHoverEvent(int r23, MotionEvent motionEvent) {
        s sVar = this.flutterIdToOrigin.get(r23);
        if (sVar == null) {
            return false;
        }
        Map<View, Rect> map = this.embeddedViewToDisplayBounds;
        ...
        for (int r3 = 0; r3 < motionEvent.getPointerCount(); r3++) {
            MotionEvent.PointerProperties pointerProperties = new MotionEvent.PointerProperties();
            pointerPropertiesArr[r3] = pointerProperties;
            motionEvent.getPointerProperties(r3, pointerProperties);
            MotionEvent.PointerCoords pointerCoords = new MotionEvent.PointerCoords();
            motionEvent.getPointerCoords(r3, pointerCoords);
            MotionEvent.PointerCoords pointerCoords2 = new MotionEvent.PointerCoords(pointerCoords);
            pointerCoordsArr[r3] = pointerCoords2;
    ...
    public boolean performAction(int r3, int r4, Bundle bundle) {
        AccessibilityNodeProvider accessibilityNodeProvider;
        s sVar = this.flutterIdToOrigin.get(r3);
        if (sVar == null || (accessibilityNodeProvider = sVar.f3769a.getAccessibilityNodeProvider()) == null) {
            return false;
        }
        return accessibilityNodeProvider.performAction(sVar.f3770b, r4, bundle);
    }

    public View platformViewOfNode(int r22) {
        s sVar = this.flutterIdToOrigin.get(r22);
        if (sVar == null) {
            return null;
        }
        return sVar.f3769a;
    ...
    public boolean requestSendAccessibilityEvent(View view, View view2, AccessibilityEvent accessibilityEvent) {
        ...
        Long a4 = r.a(this.reflectionAccessors, accessibilityEvent);
        if (a4 == null) {
            return false;
        }
        int longValue = (int) (a4.longValue() >> 32);
        Integer num = this.originToFlutterId.get(new s(view, longValue));
        if (num == null) {
            int r3 = this.nextFlutterId;
            this.nextFlutterId = r3 + 1;
            Integer valueOf = Integer.valueOf(r3);
            cacheVirtualIdMappings(view, longValue, r3);
            num = valueOf;
        }
        ...
        for (int r9 = 0; r9 < obtain.getRecordCount(); r9++) {
            ...
            Long a5 = r.a(this.reflectionAccessors, record);
            if (a5 == null) {
                return false;
            }
            s sVar = new s(view, (int) (a5.longValue() >> 32));
            if (!this.originToFlutterId.containsKey(sVar)) {
                return false;
            }
            record.setSource(this.rootAccessibilityView, this.originToFlutterId.get(sVar).intValue());
        }
